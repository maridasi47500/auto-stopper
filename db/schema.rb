...
ActiveRecord::Schema[7.0].define(version: 2024_05_24_140242) do
  ...
  create_table "commandlines", force: :cascade do |t|
    t.string "title"
    t.text "content"
    t.integer "place_id"
    t.datetime "created_at", null: false
  ...
  create_table "computerhackings", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "traffic_infos", force: :cascade do |t|
    t.integer "source_id"
