...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference("Website.count") do
      post websites_url, params: { website: { path: @website.path, startcommand: @website.startcommand, title: @website.title, user_id: @website.user_id } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { path: @website.path, startcommand: @website.startcommand, title: @website.title, user_id: @website.user_id } }
